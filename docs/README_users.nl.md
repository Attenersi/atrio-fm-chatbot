...
Berichten kunnen worden opgeslagen voor de dienst en, afhankelijk van het beleid van je organisatie, voor training/review. Zie [`gdpr_data_retention.md`](gdpr_data_retention.md); de privacyverklaring van je organisatie blijft leidend.

...
Referentie: [`test_runbook.md`](test_runbook.md) (canoniek: `backend/test_runbook.md` in een volledige clone).

## Onderhoud

- Utilities: `backend/scripts/`
- Migraties/helpers: `backend/app/db_migrations.py`
- Publicatiechecklist: [`../docs/github_publish_checklist.md`](../docs/github_publish_checklist.md)
